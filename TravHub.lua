...
local Window = Rayfield:CreateWindow({
    ...
    LoadingSubtitle = "Verifying access...",
    Theme           = "Amethyst",
    ...
    KeySettings = {
        ...
        Note     = "Your key is stored privately. Contact Trav if locked out.",
        FileName = "TravHubKey",
        SaveKey  = true,      -- saves key locally so you only type it once
        GrabKeyFromSite = false,
        Key      = {"TRV-7X2K9-M4NQP-8ZHWL"}
    }
})
...
-- ═══════════════════════════════════════════
--   RENDER LOOP  (aimbot + no recoil + ESP)
-- ═══════════════════════════════════════════
local lastCamCF = nil
...
TabMisc:CreateLabel("TravHub v2.1  ·  Project Delta")
...
Rayfield:Notify({
    Title    = "TravHub v2.1",
    Content  = "Access granted. Stay lowkey 🤫",
    Duration = 5,
    Image    = 4483362458,
})
